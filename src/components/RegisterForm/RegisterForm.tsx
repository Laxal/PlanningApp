...
export const RegisterForm: FC<RegisterFormProps> = ({ func }) =>
{
  ...
  return (
    <form onSubmit={ submitHandler }>
      <BaseInput onChange={ ( e ) => { inputHandler( e ); }} type='text' name='username' value={formData.username || ''}/>
      <BaseInput onChange={ ( e ) => { inputHandler( e ); }} type='email' name='email' value={formData.email || ''}/>
      <BaseInput onChange={ ( e ) => { inputHandler( e ); }} type='password' name='password' value={formData.password || ''}/>
      <BaseInput onChange={ ( e ) => { inputHandler( e ); }} type='password' name='repeat_password' value={formData.repeat_password || ''}/>
